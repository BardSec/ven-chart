...
export const contractSchema = z.object({
  ...
  licenseCount: z.number().int().min(0).max(9999999).nullable().optional(),
  perLicenseCost: z.number().min(0).max(999999999).nullable().optional(),
  ...
  softwareManager: z.string().max(200).nullable().optional(),
